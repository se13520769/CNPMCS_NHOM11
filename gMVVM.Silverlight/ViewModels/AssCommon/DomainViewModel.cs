...
namespace gMVVM.ViewModels.AssCommon
{
    ...
    public class DomainViewModel : ViewModelBase
    {
        ...
        private ServiceKeToan.ServiceKTClient ketoanClient;
        ...
        private CM_DOMAIN currentItem;
        public CM_DOMAIN CurrentItem
        {
        ...
        private void Search()
        {
            ...
            this.currentItem.DOMAIN_NAME = this.domainName;
            this.domainClient.InsertDOMAINAsync(this.currentItem);
        ...
        private void Reload()
        {
            try
            {
                ...
                this.currentItem = new CM_DOMAIN();
                this.domainClient = new CM_DOMAINClient();
                
                this.domainClient.InsertDOMAINCompleted += new EventHandler<InsertDOMAINCompletedEventArgs>(insertDomainCompleted);
        ...
        private void insertDomainCompleted(object sender, InsertDOMAINCompletedEventArgs e)
        {
            try
            {
                if (e.Result.Result_1 == "-1")
                    this.messagePop.SetSingleError("Loi: " + e.Result.ErrorDesc);
                else
                    this.messagePop.Successful("Insert domain thanh cong");
            }
            catch (Exception)
            {
